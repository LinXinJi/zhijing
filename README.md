...
- **阶段化网状规划**：复杂目标分层成阶段，推荐主线 + 可并行支线；计划是活文档，随掌握度/关联度动态重排
- **主动连接发现**：`find-links` 按共享邻居等结构启发式找出节点间隐性联系、提议建边——联系越密，理解越深、运用越活
...
- [11 上手使用指南](docs/11-上手使用指南.md) 
- [12 调参手册与常见问题](docs/12-调参手册与常见问题.md)
